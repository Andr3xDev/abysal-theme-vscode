...
import { AbysalThemes } from './colors'
...
export default function getTheme(options: GetThemeOptions) {
  ...
  const theme = {
    ...
    colors: {
      ...
      'tree.indentGuidesStroke': v('faded'),

      'notificationCenterHeader.foreground': secondaryForeground,
      ...
      'editor.foldBackground': selectionBackgroundInActive,
      ...
      'editor.findMatchBackground': v('yellow', '44'),
      'editor.findMatchHighlightBackground': v('yellow', '2e'),
      ...
      'editor.wordHighlightBackground': v('green', '14'),
      'editor.wordHighlightStrongBackground': v('green', '22'),
      'editorBracketMatch.background': v('green', '33'),

      'diffEditor.insertedTextBackground': v('green', '38'),
      'diffEditor.removedTextBackground': v('red', '44'),
      ...
      'panelTitle.inactiveForeground': secondaryForeground,
      ...
      'terminal.ansiBlack': pick({ light: AbysalThemes.foreground[1], dark: AbysalThemes.background[0] }),
      ...
      'editor.stackFrameHighlightBackground': v('yellow', '26'),
      'editor.focusedStackFrameHighlightBackground': v('yellow', '38'),

      'peekViewEditor.matchHighlightBackground': v('yellow', '3a'),
      'peekViewResult.matchHighlightBackground': v('yellow', '3a'),
